...
ui.in_bin.addTextChangedListener(new android.text.TextWatcher({
    afterTextChanged: function(Text) {
        if (ui.in_bin.focused) {
            ui.run(() => {
                ui.in_ba.setText(Number(ui.in_bin.text()).toString(8));
                ui.in_ten.setText(Number(ui.in_bin.text()).toString(10));
                ui.in_hex.setText(Number(ui.in_bin.text()).toString(16));
            });
        }
    }
}));
...
ui.in_ba.addTextChangedListener(new android.text.TextWatcher({
    afterTextChanged: function(Text) {
        if (ui.in_ba.focused) {
            ui.run(() => {
                ui.in_bin.setText(Number(ui.in_ba.text()).toString(2));
                ui.in_ten.setText(Number(ui.in_ba.text()).toString(10));
                ui.in_hex.setText(Number(ui.in_ba.text()).toString(16));
            });
        }
    }
}));
