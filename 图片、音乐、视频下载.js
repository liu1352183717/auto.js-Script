                ...
                <frame>
                    <vertical >
                        <horizontal bg={bgcolor} alpha="1" h="45">
                            ...
                            <button id="search" text="搜索" w="60" h="40" margin="0 0 0 20" style="Widget.AppCompat.Button.Borderless.Colored" />
                            <button id="last" text="⬅" w="70" margin="0 0 0 -20" style="Widget.AppCompat.Button.Borderless.Colored" />
                            <button id="rand" text="随机" w="70" margin="0 0 0 -10" style="Widget.AppCompat.Button.Borderless.Colored" />
                            <button id="next" text="➡" w="70" margin="0 0 0 -20" style="Widget.AppCompat.Button.Borderless.Colored" />
                        </horizontal  >
